...
def build_parser():
    ...
    parser.add_argument(
        "--target", "-t", type=str, nargs="+", help="target module or package to mutate"
    )
    parser.add_argument(
        "--unit-test",
        "-u",
    ...
    parser.add_argument(
        "--report", "-r", type=str, help="generate YAML report", metavar="REPORT_FILE"
    )
    parser.add_argument(
        "--report-html", type=str, help="generate HTML report", metavar="DIR_NAME"
    )
    parser.add_argument(
        "--timeout-factor",
        "-f",
    ...
    parser.add_argument(
        "--show-mutants", "-m", action="store_true", help="show mutants source code"
    )
    parser.add_argument("--quiet", "-q", action="store_true", help="quiet mode")
    parser.add_argument("--debug", action="store_true", help="dubug mode")
    parser.add_argument(
        "--colored-output", "-c", action="store_true", help="try print colored output"
    )
    parser.add_argument(
        "--disable-stdout",
        "-d",
    ...
    parser.add_argument(
        "--list-operators", "-l", action="store_true", help="list available operators"
    )
    parser.add_argument(
